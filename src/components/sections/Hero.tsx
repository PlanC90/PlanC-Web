      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-8">
          <a
            ...
            className="w-full sm:w-auto px-8 py-3 bg-blue-600 text-white font-semibold rounded-lg shadow-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 text-center"
          >
            Telegram Group
          </a>
          ...
          <Link
            to="/#portfolio"
            className="w-full sm:w-auto px-8 py-3 bg-slate-700 text-gray-200 font-semibold rounded-lg shadow-lg hover:bg-slate-600 transition-all duration-300 transform hover:scale-105 text-center"
          >
            Track Portfolio
          </Link>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-full sm:w-auto px-8 py-3 bg-green-600 text-white font-semibold rounded-lg shadow-lg hover:bg-green-700 transition-all duration-300 transform hover:scale-105 text-center"
          >
            Buy PlanC Token
          </a>
        </div>
